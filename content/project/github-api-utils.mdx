...
- **Auth & token rotation** — Pool multiple tokens; auto-switch and backoff on rate-limit responses.
...
- **Static analysis** — Helpers that collect/normalize repo signals (stars, forks, issues/PRs, contributors, commit recency) used in downstream scoring.
- **Client-agnostic** — Works with [KnpLabs/github-api](https://github.com/KnpLabs/php-github-api) and supports **PSR-18** HTTP clients like Guzzle and Symfony HTTP client.
