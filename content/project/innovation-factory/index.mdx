...
I converted the designs into HTML/CSS/JS version then implemented it into a Wordpress theme based on Genesis Framework.

I also developed a custom plugin that extends Wordpress admin dashboard to allow site admins easily manage content, that includes
blog articles, slideshow images, their partners, clients, team members, contacts and some custom designed pages with in-page navigation
